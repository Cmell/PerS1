...
var show_feedback = function() {
  if (trial.feedback) {
    ...
    if (needKeyPress) {
      ...
      setKeyboardListeners.push(advanceTrialListener);
    } else {
...
var end_trial = function() {
  ...
  for (var i = 0; i < setKeyboardListeners.length; i++) {
    jsPsych.pluginAPI.cancelKeyboardResponse(setKeyboardListeners[i]);
  }
...
setKeyboardListeners.push(keyboardListener);
};
